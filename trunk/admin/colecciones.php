<?  include('../includes/loader.inc.php'); 
	...
	// Borro el registro
	if ($_GET['delete'])
		$db->query("DELETE FROM colecciones WHERE id_coleccion = '".addslashes($_GET['delete'])."'");

	// Obtengo el listado
	if ($listado = $db->get_results("SELECT id_coleccion, nombre, orden, descripcion FROM colecciones WHERE 1=1 ORDER BY orden DESC, nombre"))
		foreach ($listado as $l)
			$data['listado'][$l['id_coleccion']] = $l;
